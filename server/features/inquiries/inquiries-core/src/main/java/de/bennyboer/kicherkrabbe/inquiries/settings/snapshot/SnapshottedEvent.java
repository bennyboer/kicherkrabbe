package de.bennyboer.kicherkrabbe.inquiries.settings.snapshot;
...
public class SnapshottedEvent implements Event {
    ...
    public static SnapshottedEvent of(boolean enabled, RateLimits rateLimits) {
        notNull(rateLimits, "Rate limits must be given");

        return new SnapshottedEvent(enabled, rateLimits);
    }
