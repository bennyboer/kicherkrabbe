...
public class QueryAvailableColorsForFabricsHttpHandlerTest extends HttpHandlerTest {
    ...
    void shouldSuccessfullyQueryColorsAsUser() {
        ...
        when(module.getAvailableColorsForFabrics(Agent.user(AgentId.of("USER_ID")))).thenReturn(Flux.just(
