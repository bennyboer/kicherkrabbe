...
public class QueryAvailableFabricTypesForFabricsHttpHandlerTest extends HttpHandlerTest {
    ...
    void shouldSuccessfullyQueryFabricTypesAsUser() {
        ...
        when(module.getAvailableFabricTypesForFabrics(Agent.user(AgentId.of("USER_ID")))).thenReturn(Flux.just(
