...
public class LookupColor {
    ...
    public static LookupColor of(ColorId id, ColorName name, int red, int green, int blue, Instant createdAt) {
        ...
        return new LookupColor(id, name, red, green, blue, createdAt);
    }
