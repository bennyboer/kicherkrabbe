...
public class ColorDetails {
    ...
    public static ColorDetails of(ColorId id, ColorName name, int red, int green, int blue, Instant createdAt) {
        ...
        return new ColorDetails(id, name, red, green, blue, createdAt);
    }
