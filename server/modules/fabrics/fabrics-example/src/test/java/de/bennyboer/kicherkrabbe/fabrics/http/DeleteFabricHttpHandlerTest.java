...
public class DeleteFabricHttpHandlerTest extends HttpHandlerTest {

    @Test
    void shouldSuccessfullyDeleteFabric() {
        // given: a valid token for a user
        var token = createTokenForUser("USER_ID");

        // and: the module is configured to return a successful response
        when(module.deleteFabric(
                "FABRIC_ID",
                3L,
        ...
        var exchange = client.delete()
                .uri("/api/fabrics/FABRIC_ID/?version=3")
