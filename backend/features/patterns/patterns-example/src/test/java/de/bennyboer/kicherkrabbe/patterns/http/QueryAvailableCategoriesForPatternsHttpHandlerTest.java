...
public class QueryAvailableCategoriesForPatternsHttpHandlerTest extends HttpHandlerTest {

    @Test
    void shouldSuccessfullyQueryAvailableCategoriesForPatternsAsUser() {
        // given: a valid token for a user
        var token = createTokenForUser("USER_ID");

        // and: the module is configured to return a successful response
        when(module.getAvailableCategoriesForPatterns(Agent.user(AgentId.of("USER_ID")))).thenReturn(Flux.just(
