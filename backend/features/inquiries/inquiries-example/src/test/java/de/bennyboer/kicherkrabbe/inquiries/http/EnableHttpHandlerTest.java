...
public class EnableHttpHandlerTest extends HttpHandlerTest {

    @Test
    void shouldSuccessfullyEnableInquiries() {
        ...
        var exchange = client.post()
                .uri("/api/inquiries/settings/enable")
    ...
    void shouldRespondWithForbiddenForMissingPermission() {
        ...
        when(module.setSendingInquiriesEnabled(eq(true), eq(Agent.user(AgentId.of("USER_ID"))))).thenReturn(Mono.error(
