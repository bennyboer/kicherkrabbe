...
public class LookupOffer implements VersionedReadModel<OfferId> {
    ...
    public static LookupOffer of(
        ...
        return new LookupOffer(id, version, product, images, links, fabricComposition, pricing, notes, published, reserved, createdAt, archivedAt);
    }
