...
public class PublishedOffersPage {
    ...
    List<PublishedOffer> results;

    public static PublishedOffersPage of(long skip, long limit, long total, List<PublishedOffer> results) {
        ...
        return new PublishedOffersPage(skip, limit, total, results);
    }
