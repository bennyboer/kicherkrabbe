...
import de.bennyboer.kicherkrabbe.offers.api.responses.RemoveDiscountResponse;
...
public class RemoveDiscountHttpHandlerTest extends HttpHandlerTest {

    @Test
    void shouldSuccessfullyRemoveDiscount() {
        var token = createTokenForUser("USER_ID");

        when(module.removeOfferDiscount(
                "OFFER_ID",
                0L,
        ...
        var exchange = client.post()
                .uri("/offers/OFFER_ID/discount/remove?version=0")
                .headers(headers -> headers.setBearerAuth(token))
                .exchange();

        exchange.expectStatus().isOk();
        var response = exchange.expectBody(RemoveDiscountResponse.class)
                .returnResult()
                .getResponseBody();
    ...
    void shouldRespondWithForbiddenForMissingPermission() {
        ...
        when(module.removeOfferDiscount(
                ...
                Permission.builder()
                        ...
                        .isAllowedTo(Actions.REMOVE_DISCOUNT)
