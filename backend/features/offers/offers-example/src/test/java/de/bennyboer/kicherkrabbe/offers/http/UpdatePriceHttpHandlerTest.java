...
import de.bennyboer.kicherkrabbe.offers.api.requests.UpdatePriceRequest;
import de.bennyboer.kicherkrabbe.offers.api.responses.UpdatePriceResponse;
...
public class UpdatePriceHttpHandlerTest extends HttpHandlerTest {

    @Test
    void shouldSuccessfullyUpdatePrice() {
        ...
        var exchange = client.post()
                .uri("/offers/OFFER_ID/price/update")
                .bodyValue(request)
                .headers(headers -> headers.setBearerAuth(token))
                .exchange();

        exchange.expectStatus().isOk();
        var response = exchange.expectBody(UpdatePriceResponse.class)
                .returnResult()
                .getResponseBody();
    ...
    void shouldRespondWithForbiddenForMissingPermission() {
        ...
        when(module.updateOfferPrice(
                ...
                Permission.builder()
                        ...
                        .isAllowedTo(Actions.UPDATE_PRICE)
